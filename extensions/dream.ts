...
function dreamPrompt(cwd: string): string {
	return [
		...
		"   - CONFIRM DISCIPLINE (verified live, twice): the supersession engine can semantically",
		"     mis-target — a proposal's preview.invalidates may name an UNRELATED fact. Before ANY",
		"     knowledge.confirm, read preview.invalidates in full and confirm ONLY when every entry is",
		"     the fact you intended; otherwise knowledge.reject the proposal and report it.",
