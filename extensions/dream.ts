...
function dreamPrompt(cwd: string): string {
	return [
		...
		"   session digests), knowledge.stale_claims, knowledge.gaps, and pending writeback proposals.",
		...
		"   - near-duplicate facts: propose a merge with knowledge.correct (supersede the weaker copy)",
